...
public final class NetworkUtils {
    ...
    public static void openWirelessSettings() {
        BaseApplication.getInstance().getApplicationContext().startActivity(
    ...
    public static boolean getWifiEnabled() {
        ...
        WifiManager manager = (WifiManager) BaseApplication.getInstance().getApplicationContext().getSystemService(WIFI_SERVICE);
